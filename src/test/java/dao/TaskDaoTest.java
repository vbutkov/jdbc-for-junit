...
//    @Test
//    public void testDockerContainerIsRun() {
//        System.out.println("DockerContainer with postgres is successfully");
//    }
    ...
    public void testFinishSetsCorrectFlagInDb() {
        Task task = new Task("test task", true, LocalDateTime.now());
        taskDao.save(task);
